// This separate JavaScript Toolkit class is maintained by separate authors at:
// https://github.com/gs1/GS1DigitalLinkCompressionPrototype/tree/master/src
...
export default class GS1DigitalLinkToolkit
{
    ...
    constructor()
    {
        ...
        const aitable = [{
            ...
            "title": "Third Party Controlled, Serialised Extension of GTIN",
            "label": "TPX",
            "ai": "235",
            "format": "X28",
            "type": "D",
            "fixedLength": false,
            "regex": "([\\x21-\\x22\\x25-\\x2F\\x30-\\x3F\\x41-\\x5A\\x5F\\x61-\\x7A]{0,28})"
        }, {
            ...
            "title": "Amount payable per unit of measure single monetary area (variable measure trade item). No decimal point",
            "label": "Price/UoM",
            "ai": "3950",
            "format": "N6",
            "type": "D",
            ...
            "title": "Amount payable per unit of measure single monetary area (variable measure trade item). One decimal place",
            "label": "Price/UoM",
            "ai": "3951",
            "format": "N6",
            "type": "D",
            ...
            "title": "Amount payable per unit of measure single monetary area (variable measure trade item). Two decimal places",
            "label": "Price/UoM",
            "ai": "3952",
            "format": "N6",
            "type": "D",
            ...
            "title": "Amount payable per unit of measure single monetary area (variable measure trade item). Three decimal places",
            "label": "Price/UoM",
            "ai": "3953",
            "format": "N6",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to Company name",
            "label": "SHIP TO COMP",
            "ai": "4300",
            "format": "X..35",
            "type": "D",
            "fixedLength": false,
            "regex": "([\\x21-\\x22\\x25-\\x2F\\x30-\\x3F\\x41-\\x5A\\x5F\\x61-\\x7A]{0,35})"
        }, {
            "title": "Ship-to / Deliver-to contact name",
            "label": "SHIP TO NAME",
            "ai": "4301",
            "format": "X..35",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to address line 1",
            "label": "SHIP ADD1",
            "ai": "4302",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to address line 2",
            "label": "SHIP ADD2",
            "ai": "4303",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to suburb",
            "label": "SHIP SUB",
            "ai": "4304",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to locality",
            "label": "SHIP TO LOC",
            "ai": "4305",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to region",
            "label": "SHIP TO REG",
            "ai": "4306",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to country code",
            ...
            "title": "Ship-to / Deliver-to telephone number",
            "label": "SHIP TO PHONE",
            "ai": "4308",
            "format": "X..30",
            "type": "D",
            ...
            "title": "Ship-to / Deliver-to GEO location",
            "label": "SHIP TO GEO",
            "ai": "4309",
            "format": "N20",
            "type": "D",
            ...
            "title": "Return-to address line 1",
            "label": "RTN TO ADD1",
            "ai": "4312",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Return-to address line 2",
            "label": "RTN TO ADD2",
            "ai": "4313",
            "format": "X..70",
            "type": "D",
            ...
            "title": "Return-to country code",
            "label": "RTN TO COUNTRY",
            "ai": "4317",
            "format": "X2",
            "type": "D",
            "fixedLength": true,
            ...
            "title": "Return-to telephone number",
            "label": "RTN TO PHONE",
            "ai": "4319",
            "format": "X..30",
            "type": "D",
            ...
            "title": "Not before delivery date/time",
            "label": "NBEF DEL DT",
            "ai": "4324",
            "format": "N..10",
            "type": "D",
            ...
            "title": "Not after delivery date/time",
            "label": "NAFT DEL DT",
            "ai": "4325",
            "format": "N..10",
            "type": "D",
            ...
            "title": "GS1 UIC with Extension 1 and Importer index",
            "label": "UIC + EXT",
            "ai": "7040",
            "format": "X4",
            "type": "D",
            "fixedLength": true,
            "regex": "(\\d{1}[\\x21-\\x22\\x25-\\x2F\\x30-\\x3F\\x41-\\x5A\\x5F\\x61-\\x7A]{3})"
        }, {
        ...
        // Element Strings with predefined length using GS1 Application Identifiers, as defined in GS1 Gen Specs - see
        // Figure 7.8.4-2 of GS1 Gen Specs v18 at https://www.gs1.org/docs/barcodes/GS1_General_Specifications.pdf
        ...
        // tableP indicates for any initial two digits, what is the total length of the numeric AI key, e.g. "80":4 -->
        // all AI keys beginning with 80 are four digit AI keys, 80xx
        const tableP = {
            "00": 2,
            "01": 2,
            "02": 2,
        ...
        // we'll initially use 0A-0F through 9A-9F to keep Ah - Eh unallocated and reserve Fh for support for non-GS1
        // keys from the URI query string
        const tableOpt = {
            "0A": ["01", "22"],
            "0B": ["01", "10"],
            "0C": ["01", "21"],
        ...
        // tableS1 is used for the semantic interpretation and expresses which simple keys or compound keys are
        // instance identifiers (uniquely identifying only one thing globally)
        const tableS1 = {
            "01": {"requires": ["21", "235"]},
            "00": {"requires": null},
            "8006": {"requires": ["21"]},
        ...
        // this is incomplete but sufficient for initial testing		// TODO extend tableS1 fully.  Format is
        // primary key : null or list of AIs of which one must be specified.

        // pathSequenceConstraints is used to ensure that for those primary identification keys in which multiple key
        // qualifiers may appear in the URI path information, they SHALL appear in the expected order note that
        // currently only GTIN (01) and ITIP (8006)  have more than one permitted key qualifier
        ...
        const stringSemantics = {
            ...
            "417": ["gs1:partyGLN"],
            "4309": ["gs1:geocode"],
            "4320": ["gs1:serviceCodeDescription"],
            "8003": ["gs1:grai"],
            "8004": ["gs1:giai"],
            "8006": ["gs1:itip"],
            "8010": ["gs1:cpid"],
            "8011": ["gs1:hasCPIDSerialNumber"],
            "8013": ["gs1:gmn"],
            "8017": ["gs1:gsrnp"],
            "8018": ["gs1:gsrn"],
            "8019": ["gs1:srin"]
        ...
        const classSemantics = {
            ...
            "00": ["gs1:LogisticUnit"],
            "253": ["gs1:Document", "foaf:Document", "schema:CreativeWork"],
            "255": ["gs1:Coupon"],
            "401": ["gs1:Consignment"],
            "402": ["gs1:Shipment"],
            "8003": ["gs1:ReturnableAsset"],
            "8004": ["gs1:IndividualAsset"],
            "8006": ["gs1:IndividualTradeItemPiece", "gs1:Product", "schema:Product"],
            "8010": ["gs1:Component"],
            "8013": ["gs1:ProductModel"],
            "8017": ["gs1:ServiceProvider"],
            "8018": ["gs1:ServiceRecipient"],
            "8019": ["gs1:ServiceInstance"]
        };
        ...
        const dateSemantics = {
            ...
            "4326": ["gs1:releaseDate"],
            "7006": ["gs1:firstFreezeDate"]
        };

        const dateTimeHoursSemantics = {
            "4324": ["gs1:deliverNotBeforeDateTime"],
            "4325": ["gs1:deliverNotAfterDateTime"]
        };
        ...
        // safeBase64Alphabet is a modified URI-safe Base64 alphabet used in the compression methods for converting the
        // binary string to/from an alphanumeric representation that contains no characters that are restricted in URIs
        ...
        {
            tableOptReverse[JSON.stringify(tableOpt[tableOptKeys[i]].slice(0)
                .sort())] = tableOptKeys[i];
        }
        ...
        // this table is not symmetrical - it's one-way, given condition, require OR, AND, XOR to be satisfied where
        // specified
    ...
    percentEncode(input)
    {
        ...
        for (let i = 0; i < input.length; i++)
        {
            ...
            {
                escaped.push("%" + testChar.charCodeAt(0)
                    .toString(16)
                    .toUpperCase());
            }
            else
    ...
    // this method will convert either a bracketed element string or an unbracketed element string into an associative
    // array input could be "(01)05412345000013(3103)000189(3923)2172(10)ABC123"; or input could be
    // "3103000189010541234500001339232172"+groupSeparator+"10ABC123";
    extractFromGS1elementStrings(elementStrings)
    {
        ...
        else
        {
            ...
            do
            {
                ...
                {
                    // the first two digits are not within the array of GS1 Application Identifiers of defined fixed
                    // length

                    // if string contains group separator
                    let gsloc = elementStrings.substr(cursor)
                        .indexOf(gs);
                    if (gsloc > -1)
                    {
    ...
    // this method converts an associative array of GS1 Application Identifiers and their values into a GS1 Digital
    // Link URI set useShortText = true if you wish to use alphabetic mnemonic short names, e.g. /gtin/ instead of /01/
    // set uriStem to a value e.g. 'https://example.org' if you wish to use a specific domain name setting uriStem to
    // null, undefined or "" defaults to 'https://id.gs1.org' as the reference domain
    buildGS1digitalLink(gs1AIarray, useShortText, uriStem, nonGS1keyvaluePairs)
    {
        ...
        //			valid=false;
        //			throw new Error("The element string should contain exactly one primary identification key - it
        // contained "+identifiers.length+" "+JSON.stringify(identifiers)+"; please check for a syntax error"); } else
        // {
    ...
    // new method that converts a flat associative array of GS1 Application Identifiers and their values into a more
    // structured object in which the primary identification key, key qualifiers, data attributes and other key=value
    // pairs from the URI string are clearly identified as such.
    buildStructuredArray(gs1AIarray, otherArray)
    {
        ...
        //			valid=false;
        //			throw new Error("The element string should contain exactly one primary identification key - it
        // contained "+map.identifiers.length+" "+JSON.stringify(map.identifiers)+"; please check for a syntax error");
        // } else {
    ...
    analyseURIsemantics(gs1DigitalLinkURI)
    {
        ...
        {
            outputObject["@id"] = excludeQueryString; // this is now the uncompressed GS1 Digital Link without the
                                                      // query string
        ...
        let pathComponents = rv2.pathComponents.substr(1)
            .split("/");
    ...
    analyseURI(gs1DigitalLinkURI, extended)
    {
        ...
        for (let i in pcr)
        {
            ...
            if ((numkey !== "") && searching)
            {
                if (this.aiMaps.identifiers.indexOf(numkey) > -1)
                {
                    ...
                    relevantPathComponents = pcr.slice(0, (parseInt(i) + 1))
                        .reverse();
                    uriStemPathComponents = pcr.slice(parseInt(i) + 1)
                        .reverse();
                }
            }
        }
        ...
        if ((relevantPathComponents.length === 3) && (this.regexSafe64.test(relevantPathComponents[2])))
        {
            if (this.aiRegex[numericPrimaryIdentifier].test(decodeURIComponent(relevantPathComponents[1])))
            {
                ...
                rv.uncompressedPath = "/" + relevantPathComponents.slice(0, 2)
                    .join("/");
    ...
    // this method converts a GS1 Digital Link URI into an associative array of GS1 Application Identifiers and their
    // values it is the inverse function of buildGS1gs1DigitalLinkURI(gs1AIarray,useShortText,uriStem)
    extractFromGS1digitalLink(gs1DigitalLinkURI)
    {
        ...
        let splitPath = uriPathInfo.split("/")
            .slice(1);
        ...
        // check that each entry in the associative array has correct syntax  and correct digit (where
        // appropriate)
        for (let k in candidates)
        {
            if (candidates.hasOwnProperty(k))
    ...
    extractFromCompressedGS1digitalLink(gs1DigitalLinkURI)
    {
        ...
        if (queryString !== "")
        {
            ...
            {
                let p = pairs[i].split("=");
                // if the key is not numeric AND is not a shortcode such as exp or expdt, then add to the
                // nonGS1keyvalueePairs
        ...
        // insert into associative array return value any key=value pairs from the URI query string that were not
        // compressed
        for (let k in objGS1)
        {
            // need to change this to check whether key is exp / expdt or numeric GS1 key - see related method ~
            // refactor lines 951-967
            ...
            // TODO correct decompressBinaryToGS1AIarray so that expdt and 7003 do not both appear in the returned
            // arrayc
    ...
    // this method converts an associative array of GS1 Application Identifiers and their values into concatenated GS1
    // element strings set brackets=true if you want a human-readable concatenation with round brackets around GS1
    // Application Identifiers set brackets=false if you don't; in this case the group separator will be used to mark
    // the end of any field that is not defined length, except for the last element string in the concatenation
    buildGS1elementStrings(gs1AIarray, brackets)
    {
        // if brackets=true, use GS1 Digital Link ordering - identifier, qualifiers then data attributes in numeric
        // order
        ...
        if (brackets === true)
        {
            ...
            //			if (identifiers.length !== 1) {
            //				throw new Error("The associative array should contain exactly one primary identification
            // key - it contained "+identifiers.length+" "+JSON.stringify(identifiers)+"; please check for a syntax
            // error"); } else {
    ...
    {
        // creates a binary string fragment that starts with a 3-digit encoding indicator, any lengthBits specified
        // (empty string "" if not required for a fixed-length value) and then the actual value of charstr in
        // binaryEncodingOfGS1AIKey calls buildBinaryValue() when encoding the value in binary
        switch (enc)
        {
            case 0:
                // handle all-numeric encoding
                let binLength = this.numberOfValueBits(charstr.length);
                let binValue = BigInt(charstr)
                    .toString(2);
    ...
    {
        // this method converts a string charstr into binary, using n bits per character and decoding from the supplied
        // alphabet or from ASCII when n=7 this is almost the inverse method to buildString
        let binValue = "";
    ...
    {
        // starting with a specified encoding enc (in range 0-4), binary string binstr, binary string cursor position,
        // key, number of characters to extract and associative array gs1AIarray to extend, this method determines how
        // many bits to extract (depending on the encoding), extracts those bits, advances the cursor and converts the
        // extracted bits into a string value in the appropriate encoding, which is then inserted into the specified
        // associative array	 the updated associative array and updated binary string cursor position are returned.
    ...
    compressGS1AIarrayToBinary(gs1AIarray, useOptimisations, nonGS1keyvaluePairs)
    {
        ...
        let akeysa = Object.keys(gs1AIarray)
            .sort();
        let optimisations = [];
        ...
        // then append this further by encoding binary string values for any other AI key=value pairs for which no
        // optimisations were found
        for (let i in akeysa)
        {
            let key = akeysa[i];
        ...
        // then if any non-GS1 key=value pairs were also to be compressed, also compress those and append to the binary
        // string note that hex value F ('1111') is used as a flag (as a reserved value of h1) to indicate that what
        // follows is a compressed binary representation of a non-GS1 key=value pair we permit key lengths up to 128
        // characters only from the URI-safe base64 alphabet (A-Z a-z 0-9 hyphen and underscore)
    ...
    binaryEncodingOfGS1AIKey(key)
    {
        ...
        for (let i = 0; i < key.length; i++)
        {
            binAI += this.padToLength(parseInt(key.charAt(i), 16)
                .toString(2), 4);
        }
        return binAI;
    }
        ...
        if (this.tableF.hasOwnProperty(key))
        {
            ...
            for (let j in this.tableF[key])
            {
                ...
                if ((tx.hasOwnProperty("L")) && (tx.E === "N"))
                {
                    ...
                    let binValue = this.padToLength(BigInt(charstr)
                        .toString(2), this.numberOfValueBits(tx.L));
                    binstr += binValue;
                }
                ...
                if ((tx.hasOwnProperty("M")) && (tx.E === "N"))
                {
                    ...
                    let binValue = this.padToLength(BigInt(charstr)
                        .toString(2), this.numberOfValueBits(charstr.length));
    ...
    decompressGS1DigitalLinkToStructuredArray(compressedDigitalLinkURI)
    {
        ...
        let gs1AIarray = extracted.GS1;
        let otherArray = extracted.other;
        return this.buildStructuredArray(gs1AIarray, otherArray);
    }
    ...
    compressGS1DigitalLink(digitalLinkURI, useShortText, uriStem, uncompressedPrimary, useOptimisations, compressOtherKeyValuePairs)
    {
        ...
        return this.buildCompressedGS1digitalLink(gs1AIarray, useShortText, uriStem, useOptimisations, compressOtherKeyValuePairs, nonGS1keyvaluePairs);
    }
