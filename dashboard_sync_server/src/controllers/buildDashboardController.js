...
const buildSyncDashboardRun = async (lastHeardDateTime, fullBuildFlag) => {
  ...
  try {
    ...
    logThis('DashboardDoc SYNC to database successfully');
...
module.exports = buildSyncDashboardRun;
