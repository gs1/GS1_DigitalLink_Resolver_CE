...
const encodeStringToBase64 = (stringToEncode) => {
  const aUTF16CodeUnits = new Uint16Array(stringToEncode.length);
  Array.prototype.forEach.call(aUTF16CodeUnits, (el, idx, arr) => {
...
const decodeBase64ToString = (base64EncodedString) => {
  const base64StringWithHeaderRemoved = base64EncodedString.replace('data:text/plain;charset=utf-16;base64,', '');
